...
export default async function UsagePage() {
  ...
  const terminal = rows.filter((r: any) => ['settled', 'released', 'failed_ambiguous'].includes(r.status))
  ...
  return (
    <div className="page-stack">
      ...
      <div className="usage-summary">
        ...
        <div className="surface mini-stat"><span>Tỷ lệ settled</span><strong>{successRate}%</strong></div>
      </div>
                ...
                {rows.map((r: any) => {
                  ...
                  return (
                    <tr key={r.id}>
                      ...
                      <td><strong>{formatCreditUsageFromMicros(r.retail_cost_micros ?? '0')}</strong></td>
